...
export function PaintCalculator() {
  ...
  return (
    <section id="calculator" className="bg-ivory px-6 py-section-y md:px-section-x">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <span className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 font-sans text-xs uppercase tracking-wider text-muted">
                    sq ft
                  </span>
                </div>
                {errors.area && (
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        coats === n
                          ...
                          : "border border-ivory-text/15 text-muted hover:border-ivory-text/40",
                      )}
                    >
                      {n} coat{n > 1 ? "s" : ""}
                    </button>
              ...
              <Magnetic className="block w-full">
                <button
                  ...
                  className="mt-2 w-full rounded bg-orange p-4 font-sans text-sm font-bold uppercase tracking-[2px] text-white transition-[background-color,transform] duration-200 hover:-translate-y-0.5 hover:bg-orange-deep focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ivory active:translate-y-0 disabled:opacity-60"
                >
              ...
              {result && (
                ...
                >
                  <div className="mt-8 border-t border-ivory-text/10 pt-8">
                    <p className="font-display text-[44px] font-bold leading-tight text-ivory-text">
                      You need {result.litres} litres
                    </p>
                    <p className="mt-2 font-sans text-xl font-semibold text-gold">
