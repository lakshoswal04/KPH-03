...
// bedroom-base.jpg + bedroom-wall-mask.png are generated by
// backend/scripts/make_wall_mask.py from the user's bedroom photo: the base has
// the wall neutralized to light gray (shading preserved), and the mask's alpha
// covers exactly the wall. multiply(colour, neutral-gray-shading) therefore
// renders any shade — pale white to deep navy — true to its hex, softly shaded
// by the room's real lighting, with furniture/curtains/floor untouched.
// mask-size/position mirror the img's object-cover crop so they stay aligned.
const WALL_MASK = 'url("/room/bedroom-wall-mask.png")';
...
export function WallPreview({ colour }: { colour: string }) {
  ...
  return (
    <div className="relative h-[360px] w-full overflow-hidden rounded-[16px]">
      <img
        src="/room/bedroom-base.jpg"
        alt="Bedroom wall preview"
