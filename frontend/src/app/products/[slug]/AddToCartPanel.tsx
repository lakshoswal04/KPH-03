    ...
    <div className="mt-8 flex flex-wrap items-center gap-4">
      <div className="flex items-center rounded-btn border border-ivory-text/15">
        <button
          ...
          className="px-4 py-3 font-sans text-ivory-text transition-colors hover:text-orange"
        >
          −
        </button>
        <span className="min-w-[2.5rem] text-center font-sans text-sm font-semibold text-ivory-text">
          {quantity}
        </span>
        <button
          type="button"
